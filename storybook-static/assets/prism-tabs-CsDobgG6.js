import{i as d,a as p,b as n}from"./lit-element-Dl74xXHy.js";import{s as v,t as u}from"./shared-styles-DtmCOQje.js";import{n as c}from"./property-DDJpMEtn.js";var f=Object.defineProperty,h=Object.getOwnPropertyDescriptor,b=(e,t,o,r)=>{for(var s=r>1?void 0:r?h(t,o):t,l=e.length-1,i;l>=0;l--)(i=e[l])&&(s=(r?i(t,o,s):i(s))||s);return r&&s&&f(t,o,s),s};let a=class extends p{constructor(){super(...arguments),this.tabs=[],this.activeTab=""}_selectTab(e){this.activeTab=e,this.dispatchEvent(new CustomEvent("tab-change",{detail:{activeTab:e}}))}render(){return n`
